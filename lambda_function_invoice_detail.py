...
def lambda_handler(event, context):
    ...
    try:
        ...
        validateResp=ro_manager.Validate_InvoiceDetail_inputs(document_id,document_type,auth_json)
        ...
        item=ro_resp['item']
        pre_resp=ro_manager.prepareInvoice(item,auth_json)
        ...
        res_json=pre_resp['invoice']   
        logger.debug("store_code="+store_code+", INVOICE_DETAIL_JSON :"+str(res_json))    
        status="SUCCESS"                               
        return resHandler.GetAPIResponse(res_json)
